            ...
            <div key={question.id} className="rounded-lg border p-4">
              ...
              {question.type === "free_response" && (
                <div className="space-y-2">
                  <div className="text-sm"><span className="font-medium text-muted-foreground">Your answer: </span>{answer?.user_answer}</div>
                  {answer?.ai_feedback && <div className="text-sm rounded-md bg-muted p-3"><span className="font-medium text-muted-foreground">Feedback: </span>{answer.ai_feedback}</div>}
                  {question.model_answer && <div className="text-sm text-muted-foreground"><span className="font-medium">Model answer: </span>{question.model_answer}</div>}
                </div>
              )}
            </div>
          );
